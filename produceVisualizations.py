...
meanplot.set_xticklabels(getTickLabels(gradeSumByDate.loc[gradeSumByDate['grade'] == 'A'].sort_values('order')))
sumplot = gradeSumByDate.pivot(index='issue_d', columns='grade', values='sum').plot()
sumplot.set_xlabel('Issue Month')
sumplot.set_xticklabels(getTickLabels(gradeSumByDate.loc[gradeSumByDate['grade'] == 'A'].sort_values('order')))
countplot = gradeSumByDate.pivot(index='issue_d', columns='grade', values='count').plot()
countplot.set_xlabel('Issue Month')
countplot.set_xticklabels(getTickLabels(gradeSumByDate.loc[gradeSumByDate['grade'] == 'A'].sort_values('order')))
